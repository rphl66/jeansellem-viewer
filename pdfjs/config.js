// =========================================================
// JEANSELLEM — PDF Viewer (UI + barre flottante interne)
// =========================================================
...
instance.UI.addEventListener(instance.UI.Events.VIEWER_LOADED, () => {
  ...
  // --- Cacher des éléments et options de menu
  const HIDE_IDS = [
  ...
  // --- Bouton plein écran dans la barre d’en-tête (optionnel)
  const fullscreenSVG =
  ...
  function mountToolbar(){
    ...
    document.body.appendChild(bar); // important : dans l’iframe
