// =========================================================
// JEANSELLEM — PDF Viewer (UI settings + barre interne)
// =========================================================
window.addEventListener('viewerLoaded', () => {
  ...
  const HIDE_IDS = [
    ...
    // Ne garder que Continuous + Single
  ...
  // Bouton Fullscreen custom dans la barre (icône inline)
  const fullscreenSVG =
  ...
  // Mobile : une page (couverture), page-by-page, FitWidth
  ...
  new MutationObserver(mountInternalToolbar).observe(root, { childList:true, subtree:true });
});
